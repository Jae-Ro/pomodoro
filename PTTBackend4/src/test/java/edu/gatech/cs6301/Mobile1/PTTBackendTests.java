...
public class PTTBackendTests {
    ...
    protected CloseableHttpResponse updateUser(String id, String firstname, String lastname) throws IOException {
    ...
    protected CloseableHttpResponse createSession(String userId, String projectId, String startTime, String endTime,
    ...
    protected CloseableHttpResponse updateSession(String userId, String projectId, String sessionId, String startTime,
    ...
    protected CloseableHttpResponse getReport(String userId, String projectId, String from, String to,
        ...
        String url = baseUrl + "/users/" + userId + "/projects/" + projectId + "/report" + "?from=" + from + "&to="
                + to;
