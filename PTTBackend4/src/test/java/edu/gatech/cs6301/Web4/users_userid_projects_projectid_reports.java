...
public class users_userid_projects_projectid_reports {
    ...
    public void getReportTest() throws Exception {
        ...
        try {
            ...
            response = getReport(userIdstr, projectIdstr);
        ...
        //     expectedJson = "{\"userid\":\"" + userId + "\",\"projectid\":\"" + projectId + "\"}";
	    // JSONAssert.assertEquals(expectedJson,strResponse, false);
        //     EntityUtils.consume(response.getEntity());
        //     response.close();
        } finally {
    ...
    private CloseableHttpResponse getReport(String userId, String projectId) throws IOException {
